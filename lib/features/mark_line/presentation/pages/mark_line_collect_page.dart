...
/// 标记线采集页面
class MarkLineCollectPage extends StatefulWidget {
  const MarkLineCollectPage({super.key});

  @override
  State<MarkLineCollectPage> createState() => _MarkLineCollectPageState();
}

class _MarkLineCollectPageState extends State<MarkLineCollectPage> {
